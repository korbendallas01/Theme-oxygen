...
<koken:load limit="4">
	<koken:head>
		...
		<meta property="og:title" content="{{ language.kcs_featured_images }}" />
		...
		<title>{{ language.kcs_featured_images }} - {{ site.title }}</title>
	</koken:head>
</koken:load>
<main role="main">
...
<koken:else>
	<h1 class="entry page-name page-content direct-access">No featured content found, return to the <koken:link to="home">home page</koken:link></h1>
	<koken:note>
		No featued content found, please assign some in the library
	</koken:note>
</koken:load>
